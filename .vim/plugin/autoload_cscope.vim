...
function s:Cycle_macros_menus()
  ...
  if cscope_connection()
    ...
    if has("menu")
      menu &Cscope.Find.Symbol<Tab><c-\>s :cs find s <C-R>=expand("<cword>")<CR><CR>
      menu &Cscope.Find.Definition<Tab><c-\>g
        \ :cs find g <C-R>=expand("<cword>")<CR><CR>
      menu &Cscope.Find.Called<Tab><c-\>d
        \ :cs find d <C-R>=expand("<cword>")<CR><CR>
      menu &Cscope.Find.Calling<Tab><c-\>c
        \ :cs find c <C-R>=expand("<cword>")<CR><CR>
      menu &Cscope.Find.Assignment<Tab><c-\>t
        \ :cs find t <C-R>=expand("<cword>")<CR><CR>
      menu &Cscope.Find.Egrep<Tab><c-\>e
        \ :cs find e <C-R>=expand("<cword>")<CR><CR>
      menu &Cscope.Find.File<Tab><c-\>f
        \ :cs find f <C-R>=expand("<cword>")<CR><CR>
      menu &Cscope.Find.Including<Tab><c-\>i
        \ :cs find i <C-R>=expand("<cword>")<CR><CR>
"      menu &Cscope.Add :cs add 
"      menu &Cscope.Remove  :cs kill 
      menu &Cscope.Reset :cs reset<cr>
      menu &Cscope.Show :cs show<cr>
